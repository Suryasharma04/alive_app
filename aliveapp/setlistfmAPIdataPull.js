...
const populateDatabase = async (artistMbid) => {
...
(async () => {
  const aMbid = await getArtistMBID("Coldplay");
  console.log(aMbid); // Check if the MBID is correct
  await populateDatabase(aMbid); // Wait for the database population
})();
